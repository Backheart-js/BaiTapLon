      ...
      <form action="process-login.php" class="form-login" method="post">
        ...
        <div class="modal__body">
          <div class="modal__body-icon col-md col-sm row">
              ...
              <!---->
              <use
                xlink:href="/img/icons.c121c832.svg#blue-pink-balls"
                xmlns:xlink="http://www.w3.org/1999/xlink"
              ></use>
            
              <div class="form-text">
               <svg data-v-337e9a4c="" xmlns="http://www.w3.org/2000/svg" data-v-0f36bfa4="" style="fill: currentcolor; height: 1.5rem; width: 1.5rem;"><!----><use xlink:href="/img/icons.c121c832.svg#blue-pink-balls" xmlns:xlink="http://www.w3.org/1999/xlink"></use></svg>
              ...
              <div class="col-md-12  password">
                <input
                  type="password"
                  class="form-control form-cotrol-password"
              ...
              <button type="button" class="btn btn-primary" type="submit" name="btnLogin">Đăng nhập</button>
