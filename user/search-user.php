...
<body>
                    ...
                    <div class="navbar__cate-wrap col-lg-9 hide-on-tab-mobile">
                        <ul class="navbar__cate-list">
                            <li class="navbar__cate-item">
                                <a href="/BaiTapLon/user/personal-page-user/Albums.php" class="navbar__cate-link">Bạn</a>
                                <ul class="navbar__subcate-list">
                                    <li class="navbar__subcate-item">
                                        <a href="/BaiTapLon/user/personal-page-user/about.php" class="navbar__subcate-link">Giới thiệu</a>
                                    </li>
                                    <li class="navbar__subcate-item">
                                        <a href="/BaiTapLon/user/personal-page-user/Albums.php" class="navbar__subcate-link">Kho ảnh</a>
                                    </li>
                                    <li class="navbar__subcate-item">
                                        <a href="/BaiTapLon/user/personal-page-user/Albums.php" class="navbar__subcate-link">Album</a>
                                    </li>
                                    <li class="navbar__subcate-item">
                                        <a href="/BaiTapLon/user/personal-page-user/Faves.php" class="navbar__subcate-link">Yêu thích</a>
                                    </li>
                                    <li class="navbar__subcate-item">
    ...
    <input type="checkbox" hidden id="sub-cate-mobile-tab" class="sub-cate-checkbox">
        ...
        <div class="subcate-on-mobile-tablet hide-on-pc h-100" style="z-index: 5">
                ...
                <a href="/BaiTapLon/user/personal-page-user/Albums.php" class="subcate-on-mobile-tablet__link">Kho ảnh</a>
                </li>
                <li class="subcate-on-mobile-table__item">
                    <a href="/BaiTapLon/user/personal-page-user/Albums.php" class="subcate-on-mobile-tablet__link">Album</a>
                </li>
                <li class="subcate-on-mobile-table__item">
                    <a href="" class="subcate-on-mobile-tablet__link">Mục yêu thích</a>
                </li>
                <li class="subcate-on-mobile-table__item">
                    <a href="" class="subcate-on-mobile-tablet__link">Thư viện</a>
                </li>
                <li class="subcate-on-mobile-table__item">
                    <a href="" class="subcate-on-mobile-tablet__link">Nhóm</a>
                </li>
                <li class="subcate-on-mobile-table__item">
                    <a href="" class="subcate-on-mobile-tablet__link">Giới thiệu</a>
                </li>
                <li class="subcate-on-mobile-table__item">
                    <a href="" class="subcate-on-mobile-tablet__link">Cuộn camera</a>
                </li>
                <li class="subcate-on-mobile-table__item">
