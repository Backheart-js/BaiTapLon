...
<body>
            ...
            <div class="navbar__user me-3">
                <?php
                    if(isset($_SESSION['adLoginOK'])) { 
                        ...
                        echo "<a class='nav-link navbar__link text-dark'>Wellcome: ".$_SESSION['adLoginOK']."</a>";
                        echo '</li>';
                    }
                ?>
            </div>
            ...
            <div class="user-content container">
                <div class="user-infor row">
                    <div class="user__avatar col-lg-2 col-md-3">
                        <div class="user__avatar-img text-center">
                            <?php   
                                $sql="SELECT * FROM avt_images where Email='$email_user' ORDER BY uploaded_on DESC LIMIT 1";
                                $result = mysqli_query($conn,$sql);
                                ?>
                            <?php
                                if(mysqli_num_rows($result)){       
                                    while($row=mysqli_fetch_assoc($result)){
                                        $avatarURL = '../user/personal-page-user/upload-avt/data_upload/'.$row["file_name"];
                                        
                            ?>
                            <div class="avatar-user rounded-circle" style="background-image: url(<?php echo $avatarURL; ?>) "></div>
                            <?php 
                                    }
                                }
                            ?>
                    ...
                    <?php 
                        $sql = "SELECT firstname,lastname,age,email,email_verified_at FROM users WHERE email='$email_user'";
                        $result = mysqli_query($conn,$sql);
                        if(mysqli_num_rows($result)) {
                            $row = mysqli_fetch_assoc($result);
                    ?>

                    <div class="user__account col-lg-7 col-md-7 mb-2 ms-4">
                    ...
                    <div class="user__count col-lg-3 col-md-2 mb-2">
                ...
                <div class="user-img">
                    ...
                    <div class="img-wrap row" style="align-items: center; justify-content: space-around;">
                        ...
                        <a href="./ad-process-delete.php?file_name=<?php echo $row['file_name']; ?>"
                            class="delete-img btn btn-danger">Delete</a>
                    </div>
                    <?php
                            }
                        }
    ...
    <!-- <script src="/BaiTapLon/admin/js/main.js"></script> -->
</body>